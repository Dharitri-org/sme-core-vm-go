...
func (context *meteringContext) DeductAndLockGasIfAsyncStep() error {
	...
	gasSchedule := context.GasSchedule().DharitriAPICost
...
func (context *meteringContext) DeductInitialGasForDirectDeployment(input core.CodeDeployInput) error {
	return context.deductInitialGas(
		input.ContractCode,
		context.gasSchedule.DharitriAPICost.CreateContract,
...
func (context *meteringContext) DeductInitialGasForIndirectDeployment(input core.CodeDeployInput) error {
	return context.deductInitialGas(
		input.ContractCode,
		0,
		context.gasSchedule.BaseOperationCost.CompilePerByte,
