...
// extern void bigIntGetDCTCallValue(void *context, int32_t destination);
...
func BigIntImports(imports *wasmer.Imports) (*wasmer.Imports, error) {
	...
	imports, err = imports.Append("bigIntGetDCTCallValue", bigIntGetDCTCallValue, C.bigIntGetDCTCallValue)
	if err != nil {
		return nil, err
	}
...
func bigIntGetUnsignedArgument(context unsafe.Pointer, id int32, destination int32) {
	bigInt := core.GetBigIntContext(context)
...
func bigIntStorageStoreUnsigned(context unsafe.Pointer, keyOffset int32, keyLength int32, source int32) int32 {
	...
	if core.WithFault(err, context, runtime.BigIntAPIErrorShouldFailExecution()) {
		return 0
	}
...
//export bigIntGetDCTCallValue
func bigIntGetDCTCallValue(context unsafe.Pointer, destination int32) {
	bigInt := core.GetBigIntContext(context)
	runtime := core.GetRuntimeContext(context)
	metering := core.GetMeteringContext(context)
...
func bigIntTDiv(context unsafe.Pointer, destination, op1, op2 int32) {
	...
	if b.Sign() == 0 {
		runtime := core.GetRuntimeContext(context)
		core.WithFault(core.ErrDivZero, context, runtime.BigIntAPIErrorShouldFailExecution())
		return
	}
...
func bigIntNot(context unsafe.Pointer, destination, op int32) {
	...
	if a.Sign() < 0 {
		runtime := core.GetRuntimeContext(context)
		core.WithFault(core.ErrBitwiseNegative, context, runtime.BigIntAPIErrorShouldFailExecution())
		return
	}
	dest.Not(a)
}
...
func bigIntShr(context unsafe.Pointer, destination, op, bits int32) {
	...
	if a.Sign() < 0 || bits < 0 {
		runtime := core.GetRuntimeContext(context)
		core.WithFault(core.ErrShiftNegative, context, runtime.BigIntAPIErrorShouldFailExecution())
		return
	}
