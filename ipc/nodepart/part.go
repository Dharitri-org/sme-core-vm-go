...
// Critical failure = Core timeouts or crashes
...
func (part *NodePart) doLoop() (common.MessageHandler, error) {
	...
	for {
		...
		if remainingMilliseconds < 0 {
			return nil, common.ErrCoreTimeExpired
		}
		...
		return nil, common.ErrBadMessageFromCore
	}
}
...
// SendStopSignal sends a stop signal to Core
...
func (part *NodePart) SendStopSignal() error {
	...
	log.Warn("Node sent stop signal to Core.")
	return nil
}
