...
// MessageKind is the kind of a message (that is passed between the Node and Core)
...
// MessageInitialize is a message sent by Node to initialize Core
...
func NewMessageInitialize(arguments CoreArguments) *MessageInitialize {
...
// MessageStop is a message sent by Node to stop Core
